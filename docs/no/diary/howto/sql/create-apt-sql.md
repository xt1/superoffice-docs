...
description: Slik oppretter du en avtale med rå SQL.
keywords: dagbok, kalender, avtale, API, SynligFor, SAINT
uid: create_appointment_sql-no
...
1. Sett inn en avtaleoppføring.
2. Sett inn en tekstpost for avtaleteksten.
3. Sett inn en SynligFor-oppføring som peker til avtaleoppføringen.
...
## Oppdatere berørte SAINT tellere
...
## Legge til synlig for oppføring for avtalen
