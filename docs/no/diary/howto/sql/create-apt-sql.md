...
description: Hvordan lage en avtale ved hjelp av rå SQL.
...
1. Sette inn en avtaleoppføring.
2. Sette inn en tekstpost for avtaleteksten.
3. Sett inn en VisibleFor-post som peker til avtaleposten.
...
## Oppdater berørte SAINT tellere
...
## Legge til oppføringen som er synlig for avtalen
